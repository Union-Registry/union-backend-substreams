...
pub mod functions {
    ...
    pub struct AcceptUnion {
        pub union_id: substreams::scalar::BigInt,
        pub token_id: substreams::scalar::BigInt,
        pub vow: String,
        pub secret: String,
    }
    impl AcceptUnion {
        const METHOD_ID: [u8; 4] = [158u8, 100u8, 172u8, 64u8];
        pub fn decode(
                ...
                &[
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.union_id.clone().to_bytes_be() {
                    ...
                    ethabi::Token::String(self.vow.clone()),
                    ethabi::Token::String(self.secret.clone()),
                ],
            );
    ...
    impl substreams_ethereum::Function for AcceptUnion {
        const NAME: &'static str = "acceptUnion";
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ExampleArray {
        pub param0: substreams::scalar::BigInt,
    }
    impl ExampleArray {
        const METHOD_ID: [u8; 4] = [232u8, 54u8, 199u8, 232u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for ExampleArray {
        const NAME: &'static str = "exampleArray";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for ExampleArray {
    ...
    impl GetUnion {
        const METHOD_ID: [u8; 4] = [59u8, 20u8, 180u8, 65u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GetUnion {
        const NAME: &'static str = "getUnion";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct Initialize {
        pub u_rings_contract: Vec<u8>,
        pub u_schema: substreams::scalar::BigInt,
        pub u_sp_instance_address: Vec<u8>,
    }
    impl Initialize {
        const METHOD_ID: [u8; 4] = [188u8, 190u8, 3u8, 223u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_rings_contract),
                    ),
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_schema.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_sp_instance_address),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ProposeUnion {
        pub token_id: substreams::scalar::BigInt,
        pub vow: String,
        pub secret_hash: [u8; 32usize],
    }
    impl ProposeUnion {
        const METHOD_ID: [u8; 4] = [96u8, 34u8, 234u8, 60u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::String(self.vow.clone()),
                    ethabi::Token::FixedBytes(self.secret_hash.as_ref().to_vec()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl substreams_ethereum::Function for ProposeUnion {
        const NAME: &'static str = "proposeUnion";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RevokeUnion {
        pub union_id: substreams::scalar::BigInt,
        pub reason: String,
    }
    impl RevokeUnion {
        const METHOD_ID: [u8; 4] = [53u8, 3u8, 2u8, 139u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::String(self.reason.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl substreams_ethereum::Function for RevokeUnion {
        const NAME: &'static str = "revokeUnion";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RingsContract {}
    impl RingsContract {
        const METHOD_ID: [u8; 4] = [40u8, 126u8, 36u8, 22u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for RingsContract {
        const NAME: &'static str = "ringsContract";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for RingsContract {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Schema {}
    impl Schema {
        const METHOD_ID: [u8; 4] = [248u8, 137u8, 92u8, 200u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Schema {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Schema {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetRingsContract {
        pub u_rings_contract: Vec<u8>,
    }
    impl SetRingsContract {
        const METHOD_ID: [u8; 4] = [225u8, 79u8, 152u8, 166u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for SetRingsContract {
        const NAME: &'static str = "setRingsContract";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl SetSchema {
        const METHOD_ID: [u8; 4] = [176u8, 99u8, 43u8, 97u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for SetSchema {
        const NAME: &'static str = "setSchema";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetSpContract {
        pub u_sp_instance_address: Vec<u8>,
    }
    impl SetSpContract {
        const METHOD_ID: [u8; 4] = [125u8, 159u8, 111u8, 250u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for SetSpContract {
        const NAME: &'static str = "setSpContract";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl SpInstance {
        const METHOD_ID: [u8; 4] = [168u8, 197u8, 220u8, 51u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for SpInstance {
        const NAME: &'static str = "spInstance";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for SpInstance {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl Unions {
        const METHOD_ID: [u8; 4] = [162u8, 15u8, 225u8, 199u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn output_call(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<([u8; 32usize], bool, substreams::scalar::BigInt), String> {
            Self::output(call.return_data.as_ref())
        }
        pub fn output(
            data: &[u8],
        ...
        pub fn call(
            &self,
            address: Vec<u8>,
        ) -> Option<([u8; 32usize], bool, substreams::scalar::BigInt)> {
            use substreams_ethereum::pb::eth::rpc;
            let rpc_calls = rpc::RpcCalls {
                calls: vec![rpc::RpcCall { to_addr : address, data : self.encode(), }],
            };
    ...
    impl substreams_ethereum::Function for Unions {
        const NAME: &'static str = "unions";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<
        ([u8; 32usize], bool, substreams::scalar::BigInt),
    > for Unions {
        fn output(
            data: &[u8],
        ) -> Result<([u8; 32usize], bool, substreams::scalar::BigInt), String> {
...
pub mod events {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct UnionAccepted {
        pub union_id: substreams::scalar::BigInt,
        pub attestation_uid: substreams::scalar::BigInt,
    }
    impl UnionAccepted {
        const TOPIC_ID: [u8; 32] = [
            12u8,
    ...
    impl substreams_ethereum::Event for UnionAccepted {
        const NAME: &'static str = "UnionAccepted";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Event for UnionProposed {
        const NAME: &'static str = "UnionProposed";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Event for UnionRevoked {
        const NAME: &'static str = "UnionRevoked";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
